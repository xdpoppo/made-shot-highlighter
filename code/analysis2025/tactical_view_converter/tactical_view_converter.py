...
class TacticalViewConverter:
    ...
    def validate_keypoints(self, keypoints_list):
        """Zeroes out detected keypoints whose relative distances don't match the known court layout."""
        ...
        for frame_idx, frame_keypoints in enumerate(keypoints_list):
            ...
            # need at least 3 points to check relative proportions
            ...
            for i in detected_indices:
                ...
                # compare distance ratios between detected points vs. the reference court layout
    ...
    def transform_players_to_tactical_view(self, keypoints_list, player_tracks):
        """Projects player foot positions from frame coordinates into tactical-view coordinates via homography."""
